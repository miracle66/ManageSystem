...
(function($, window, document, undefined) {
	...
	/*
	 * Recurse the tree structure and ensure all nodes have valid initial states. User defined states will be preserved. For performance we also take this
	 * opportunity to index nodes in a flattened structure
	 */
	...
	Tree.prototype.buildTree = function(nodes, level) {
		...
		$.each(nodes, function addNodes(id, node) {
			...
			var treeItem = $(_this.template.item).addClass('node-' + _this.elementId).addClass(node.state.checked ? 'node-checked' : '').addClass(node.state.disabled ? 'node-disabled' : '').addClass(
					node.state.selected ? 'node-selected' : '').addClass(node.searchResult ? 'search-result' : '').attr('data-nodeid', node.nodeId).attr('style', _this.buildStyleOverride(node));
	 ...
	 * 
	 * @param {Number}
	 *            nodeId - A node's unique identifier
	 ...
	 * 
	 * @param {Object|Number}
	 *            identifier - A valid node or node id
	 ...
	 * 
	 * @param {Object|Number}
	 *            identifiers - A valid node, node id or array of node identifiers
	 * @param {optional
	 *            Object} options
	 */
	 ...
	 * 
	 * @param {String}
	 *            pattern - A given string to match against
	 * @param {optional
	 *            Object} options - Search criteria options
	 ...
	 *            pattern - A given string to match against
	 * @param {optional
	 *            String} modifier - Valid RegEx modifiers
	 * @param {optional
	 *            String} attribute - Attribute to compare pattern against
	 ...
	 * 
	 * @param {Object}
	 *            obj - Typically a node, could be any object
	 * @param {String}
	 *            attr - Identifies an object property using dot notation
